    <%@ page language="java" contentType="text/html; charset=UTF-8"
        ...
        <link href="/static/stylesheets/custom_bootstrap.css" rel="stylesheet">
        ...
        <h2>Velg playlist</h2>
        <div class="well well-lg">Skriv inn navn på playlisten du vil
        bruke, og klikke "GO!"</div>

        <form ng-submit="clicked()" role="form">
        <div class="form-group">
        <input type="text" class="form-control ng-pristine ng-valid"
        ng-model="url" id="exampleInputEmail1" autocomplete="off"
        typeahead="playlist for playlist in getPlaylist($viewValue) | filter:$viewValue | limitTo:8"
        placeholder="Velg playlist">
        </div>
